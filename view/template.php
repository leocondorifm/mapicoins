                        ...
                        <div class="gamfi-btn-area">
                            <ul>
                                ...
                                <li class="buy-token">
                                    ...
                                    <ul>
                                        <li><a href="index.html#"><img src="assets/images/icons/pancake.png" alt="pancake"> PancakeSwap</a></li>
                                        <li><a href="index.html#"><img src="assets/images/icons/uniswap.png" alt="uniswap"> UniSwap</a></li>
                                        <li><a href="index.html#"><img src="assets/images/icons/market.png" alt="market"> CoinMarketCap</a></li>
                                        <li><a href="index.html#"><img src="assets/images/icons/gate.png" alt="gate"> Gate.io</a></li>
                                    </ul>
                                </li>
                                    ...
                                    <ul class="project-listing">
                                        ...
                                        <li class="social-share">
                                            ...
                                            <ul class="social-icon-list">
                                                <li><a href="index.html#"><i class="icon-telegram"></i></a></li>
                                                <li><a href="index.html#"><i class="icon-twitter"></i></a></li>
                                                <li><a href="index.html#"><i class="icon-discord"></i></a></li>
                                                <li><a href="index.html#"><i class="icon-medium"></i></a></li>
                                                <li><a href="index.html#"><i class="icon-world"></i></a></li>
                                            </ul>
                                        </li>
                                    </ul>
                                </div>
